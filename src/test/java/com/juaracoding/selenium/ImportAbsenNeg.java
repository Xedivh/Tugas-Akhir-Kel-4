...
public class ImportAbsenNeg {
    ...
    public void testImportAbsenFunctionality() throws InterruptedException {
        ...
        String filePath = projectDir + "/src/test/resources/sample_absen.docx"; // Sesuaikan nama file jika berbeda
        System.out.println("Attempting to upload file from: " + filePath);

        java.io.File testFile = new java.io.File(filePath);
        if (!testFile.exists()) {
            throw new SkipException("Test file not found at: " + filePath + ". Please create 'sample_absen.docx' in src/test/resources/.");
        }
